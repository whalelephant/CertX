...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.CredentialPacketData
	...
	case *types.CredentialPacketData_ProofPacket:
		packetAck, err := am.keeper.OnRecvProofPacket(ctx, modulePacket, *packet.ProofPacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.CredentialPacketData_ProofPacket:
		err := am.keeper.OnAcknowledgementProofPacket(ctx, modulePacket, *packet.ProofPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeProofPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.CredentialPacketData_ProofPacket:
		err := am.keeper.OnTimeoutProofPacket(ctx, modulePacket, *packet.ProofPacket)
		if err != nil {
			return nil, err
		}
	default:
