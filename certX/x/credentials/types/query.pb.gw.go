...
var (
	pattern_Query_Credential_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"whalelephant", "certx", "credentials", "credential", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CredentialAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"whalelephant", "certx", "credentials", "credential"}, "", runtime.AssumeColonVerbOpt(true)))
)
