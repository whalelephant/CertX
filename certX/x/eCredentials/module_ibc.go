...
func (am AppModule) OnRecvPacket(
	...
	if err := types.ModuleCdc.UnmarshalJSON(modulePacket.GetData(), &modulePacketData); err != nil {
		return nil, nil, sdkerrors.Wrapf(sdkerrors.ErrUnknownRequest, "certx? cannot unmarshal packet data: %s", err.Error())
	}
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.ECredentialsPacketData_ECredentialPacket:
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.ECredentialsPacketData_ECredentialPacket:
		err := am.keeper.OnTimeoutECredentialPacket(ctx, modulePacket, *packet.ECredentialPacket)
		if err != nil {
			return nil, err
		}
	default:
