...
import WhalelephantCertXWhalelephantMuggleAuthVac from './whalelephant/certX/whalelephant.muggleAuth.vac'
...
export default { 
  WhalelephantCertXWhalelephantMuggleAuthVac: load(WhalelephantCertXWhalelephantMuggleAuthVac, 'whalelephant.muggleAuth.vac'),
